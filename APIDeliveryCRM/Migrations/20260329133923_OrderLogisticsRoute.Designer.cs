...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIDeliveryCRM.Model.OrderRouteLeg", b =>
                {
                    b.Property<int>("ID_OrderRouteLeg")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ID_OrderRouteLeg"));

                    b.Property<int?>("AssignedCourier_id")
                        .HasColumnType("integer");

                    b.Property<int?>("FromAddress_id")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ToAddress_id")
                        .HasColumnType("integer");

                    b.HasKey("ID_OrderRouteLeg");

                    b.HasIndex("AssignedCourier_id");

                    b.HasIndex("FromAddress_id");

                    b.HasIndex("LogisticsHub_id");

                    b.HasIndex("Order_id");

                    b.HasIndex("ToAddress_id");

                    b.ToTable("OrderRouteLegs");
                });
            ...
            modelBuilder.Entity("APIDeliveryCRM.Model.OrderRouteLeg", b =>
                {
                    ...
                    b.HasOne("APIDeliveryCRM.Model.Address", "FromAddress")
                        .WithMany()
                        .HasForeignKey("FromAddress_id")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("APIDeliveryCRM.Model.Address", "ToAddress")
                        .WithMany()
                        .HasForeignKey("ToAddress_id")
                        .OnDelete(DeleteBehavior.Restrict);
