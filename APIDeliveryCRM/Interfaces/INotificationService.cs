...
namespace APIDeliveryCRM.Interfaces
{
    ...
    {
        Task SendAsync(int userId, int typeId, string title, string message, int? orderId = null, int? shiftId = null, byte priority = 0, bool isCritical = false, bool requiresAck = false);
